    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreHouseIngredients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StoreHouseIngredients_Ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StoreHouseIngredients_StoreHouses_StoreHouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreHouseIngredients_IngredientId",
                table: "StoreHouseIngredients",
                column: "IngredientId");

            migrationBuilder.CreateIndex(
                name: "IX_StoreHouseIngredients_StoreHouseId",
                table: "StoreHouseIngredients",
                column: "StoreHouseId");
        }
